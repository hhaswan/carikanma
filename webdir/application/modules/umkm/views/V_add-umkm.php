    ...
    <section class="account-option">
      ...
      <div class="container">
        ...
        <div class="inner-box">
          ...
          <a href="<?php echo base_url();?>signin" class="btn-style-1"><i class="fa fa-sign-in"></i>Sign in Now</a> </div>
        ...
        <form action="#">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <input type="text" placeholder="Nama UMKM anda">
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <label>Upload Surat Izin Usaha</label>
